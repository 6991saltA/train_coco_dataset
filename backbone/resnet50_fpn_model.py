...
def resnet50_fpn_backbone(pretrain_path="",
    ...
    swin_transformer_backbone = SwinTransformer(in_chans=3,
                                                patch_size=4,
                                                window_size=7,
                                                embed_dim=96,
                                                depths=(2, 2, 6, 2),
    ...
    out_channels = 256
    return BackboneWithFPN(resnet_backbone, swin_transformer_backbone, return_layers, in_channels_list, out_channels, extra_blocks=extra_blocks)
